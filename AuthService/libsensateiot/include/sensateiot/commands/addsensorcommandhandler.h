/*
 * Add sensor by object ID command handler.
 *
...
{
	class AddSensorCommandHandler : public AbstractCommandHandler {
	public:
		explicit AddSensorCommandHandler(services::MessageService& services);
		~AddSensorCommandHandler() override = default;
