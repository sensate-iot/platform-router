...
namespace SensateService.SqlSetup.Migrations
{
	public partial class UpdateIdentityTableNames : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.DropPrimaryKey(
				name: "PK_AspNetAuthTokens",
				table: "AspNetAuthTokens");

			migrationBuilder.DropPrimaryKey(
				name: "PK_AspNetApiKeys",
				table: "AspNetApiKeys");
			...
			migrationBuilder.RenameIndex(
				...
				newName: "IX_PhoneNumberTokens_UserId");
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.RenameTable(
				name: "AuthTokens",
				newName: "AspNetAuthTokens");

			migrationBuilder.RenameTable(
				name: "ApiKeys",
				newName: "AspNetApiKeys");
			...
			migrationBuilder.RenameIndex(
				name: "IX_PhoneNumberTokens_UserId",
				table: "AspNetPhoneNumberTokens",
			...
			migrationBuilder.RenameIndex(
				...
				table: "AspNetApiKeys",
				newName: "IX_AspNetApiKeys_UserId");

			migrationBuilder.RenameIndex(
				name: "IX_ApiKeys_ApiKey",
				table: "AspNetApiKeys",
				newName: "IX_AspNetApiKeys_ApiKey");
