...
namespace SensateIoT.Platform.Network.Common.Caching.Abstract
{
	public interface IDistributedCache<TValue> : IDisposable where TValue : class
	{
		...
		Task SetRangeAsync(ICollection<System.Collections.Generic.KeyValuePair<string, TValue>> values, CacheEntryOptions options = null, CancellationToken ct = default);
