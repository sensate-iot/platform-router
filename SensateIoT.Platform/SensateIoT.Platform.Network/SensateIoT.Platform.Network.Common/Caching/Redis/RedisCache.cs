...
namespace SensateIoT.Platform.Network.Common.Caching.Redis
{
	public class RedisCache<TValue> : IDistributedCache<TValue> where TValue : class
	{
		...
		public async Task SetRangeAsync(ICollection<Generics.KeyValuePair<string, TValue>> values, CacheEntryOptions options = null, CancellationToken ct = default)
		{
